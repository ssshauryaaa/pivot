...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn('relative h-full w-full bg-void', containerClassName)}>
      <div className="h-full w-full">
        <DotMatrix
          colors={colors ?? [[255, 182, 39]]}
          dotSize={dotSize ?? 3}
    ...
    for (const name in uniforms) {
      ...
      switch (uniform.type) {
        case 'uniform1f':
          ...
          break
        case 'uniform3f':
          prepared[name] = { value: new THREE.Vector3().fromArray(uniform.value), type: '3f' }
          break
        case 'uniform1fv':
        ...
        case 'uniform3fv':
          ...
          break
        case 'uniform2f':
          prepared[name] = { value: new THREE.Vector2().fromArray(uniform.value), type: '2f' }
          break
        default:
